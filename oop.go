...
import (
	...
	channel "github.com/DoniHarianto/DonChannel"
	hashmap "github.com/DoniHarianto/DonHashmap"
	modcompact "github.com/DoniHarianto/DonModcompact"
	thrift "github.com/DoniHarianto/DonThrift"
	talkservice "github.com/DoniHarianto/DonLineThrift"
...
var (
	...
	AccessUser  = []*Access{}
	Proxies       = []string{
		"donioleng:donioleng@45.114.12.66:5134",
		"donioleng:donioleng@161.123.208.226:6470",
		"donioleng:donioleng@45.114.15.43:6024",
		"donioleng:donioleng@45.114.12.196:5264",
		"donioleng:donioleng@45.114.15.92:6073",
		"donioleng:donioleng@161.123.208.10:6254",
		"donioleng:donioleng@161.123.208.157:6401",
		"donioleng:donioleng@161.123.208.225:6469",
		"donioleng:donioleng@45.114.15.51:6032",
		"donioleng:donioleng@45.114.12.238:5306",
		"donioleng:donioleng@45.114.15.99:6080",
		"donioleng:donioleng@45.114.15.202:6183",
		"donioleng:donioleng@45.114.15.152:6133",
		"donioleng:donioleng@45.114.15.157:6138",
		"donioleng:donioleng@161.123.209.181:6681",
		"donioleng:donioleng@161.123.208.144:6388",
		"donioleng:donioleng@45.114.12.41:5109",
		"donioleng:donioleng@161.123.209.162:6662",
		"donioleng:donioleng@161.123.208.167:6411",
		"donioleng:donioleng@45.114.15.9:5990",
		"donioleng:donioleng@45.114.15.65:6046",
		"donioleng:donioleng@161.123.208.130:6374",
		"donioleng:donioleng@161.123.208.139:6383",
		"donioleng:donioleng@161.123.209.207:6707",
		"donioleng:donioleng@161.123.208.232:6476",
		"donioleng:donioleng@161.123.208.31:6275",
		"donioleng:donioleng@45.114.12.116:5184",
		"donioleng:donioleng@45.114.12.99:5167",
		"donioleng:donioleng@45.114.12.98:5166",
		"donioleng:donioleng@161.123.208.247:6491",
		"donioleng:donioleng@161.123.209.254:6754",
		"donioleng:donioleng@45.114.15.5:5986",
		"donioleng:donioleng@161.123.209.213:6713",
		"donioleng:donioleng@161.123.209.200:6700",
		"donioleng:donioleng@161.123.209.87:6587",
		"donioleng:donioleng@45.114.12.89:5157",
		"donioleng:donioleng@161.123.208.50:6294",
		"donioleng:donioleng@161.123.208.24:6268",
		"donioleng:donioleng@45.114.12.189:5257",
		"donioleng:donioleng@45.114.12.27:5095",
		"donioleng:donioleng@161.123.209.16:6516",
		"donioleng:donioleng@161.123.209.148:6648",
		"donioleng:donioleng@161.123.208.214:6458",
		"donioleng:donioleng@45.114.15.215:6196",
		"donioleng:donioleng@161.123.209.6:6506",
		"donioleng:donioleng@161.123.208.158:6402",
		"donioleng:donioleng@45.114.15.48:6029",
		"donioleng:donioleng@161.123.209.125:6625",
		"donioleng:donioleng@45.114.12.253:5321",
		"donioleng:donioleng@45.114.12.234:5302",
	}
)
...
func (self *Account) AcceptTicket(groupMid string, ticketId string) (err error) {
	if self.Limited == false {
		_, err = self.ConnectTalk().AcceptChatInvitationByTicket(self.Ctx, &talkservice.AcceptChatInvitationByTicketRequest{
			ChatMid:  groupMid,
			ReqSeq:   self.Seq,
			TicketId: ticketId,
		})
...
func (s *Account) ConnectTalk() *talkservice.TalkServiceClient {
...
func (self *Account) CancelChatInvitations(groupId string, contactIds string) (err error) {
	if self.Limited == false {
		self.BackupTalk().CancelChatInvitation(self.Ctx, &talkservice.CancelChatInvitationRequest{
			ChatMid:        groupId,
			ReqSeq:         self.Seq,
...
func (self *Account) InviteIntoGroupNormal(groupId string, contactIds []string) (err error) {
	if self.Limited == false {
		_, err = self.BackupTalk().InviteIntoChat(self.Ctx, &talkservice.InviteIntoChatRequest{
			ChatMid:        groupId,
			ReqSeq:         self.Seq,
...
func (self *Account) NormalDeleteOtherFromChats(to string, contactIds string) (err error) {
	_, err = self.BackupTalk().DeleteOtherFromChat(self.Ctx, &talkservice.DeleteOtherFromChatRequest{
		ReqSeq:         0,
		ChatMid:        to,
		TargetUserMids: []string{contactIds},
	})
...
func setKC(s string) *http.Client {
	if s != "none" {
		println("\n  ↳ Proxy :", s)
		var proxyUrl, _ = url.Parse("http://" + s)
...
func setFKC(s string) *fasthttp.Client {
	if s != "none" {
		println("  ↳ Fasthttp :", s)
		return &fasthttp.Client{
			NoDefaultUserAgentHeader: false,
			MaxConnsPerHost:          1000,
			Dial:	fasthttpproxy.FasthttpHTTPDialerTimeout(s, 1 * time.Second),
		}
	} else {
		return &fasthttp.Client{
			NoDefaultUserAgentHeader: false,
...
func CreateNewLogin(token string, num int, app string, ua string, host string, ipls string, proxy string) (*Account, error) {
	Hostf4 := fmt.Sprintf("https://%s.line.naver.jp/F4", host)
...
func (cl *Account) BackupTalk() *talkservice.TalkServiceClient {
	compact := thrift.NewTCompactProtocol(thrift.ModHttpClient(cl.UrF4, cl.Transport, cl.HttpHeader))
	return talkservice.NewTalkServiceClient(thrift.NewTStandardClient(compact, compact))
}
...
func (cl *Account) DeleteSelfFromChat(to string) error {
	_, err = cl.BackupTalk().DeleteSelfFromChat(cl.Ctx, &talkservice.DeleteSelfFromChatRequest{
		ReqSeq:  0,
		ChatMid: to,
	})
	return err
...
func (self *Account) TurboInvite(lc string, kr []string) {
	if len(kr) > 3 {
		var b []string
		for x, v := range kr {
			x++
			b = append(b, v)
			if x%8 == 0 {
				self.InviteIntoGroupNormal(lc, b)
				b = []string{}
			}else{
				self.InviteIntoGroupNormal(lc, b)
			}
		...
		self.InviteIntoGroupNormal(lc, kr)
	}
}
...
func (self *Account) FastAcc(lc string) {
	var wg sync.WaitGroup
	wg.Add(1)
	go func() {
		defer wg.Done()
		self.AcceptGroupInvitationNormal(lc)
	}()
}

func (self *Account) AcceptGroupInvitationNormal(groupId string) (err error) {
	self.BackupTalk().AcceptChatInvitation(self.Ctx, &talkservice.AcceptChatInvitationRequest{
		ChatMid: groupId,
		ReqSeq:  self.Seq,
	})
	return nil
...
func (self *Account) DeleteOtherFromChat(groupId string, contactIds string) int {
	if self.Limited == false {
		_, err = self.BackupTalk().DeleteOtherFromChat(context.TODO(), &talkservice.DeleteOtherFromChatRequest{
			ChatMid:        groupId,
			ReqSeq:         self.Seq,
			TargetUserMids: []string{contactIds},
		})
...
func (self *Account) NewGetGroupUser(groupId string) (error, string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupList(groupId string) (error, string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupSelect(groupId string) (error, string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupCheck(groupId string) (error, string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupCheckLastActive(groupId string) (string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetChatListGetSquad(groupId string) (name string, mem, inv []string) {
	res, _ := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: true,
		WithMembers:  true,
...
func (self *Account) NewGetGroupLogFight(groupId string) (string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupNuke(groupId string) (string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupAcceptJoin(groupId string) (string, map[string]int64) {
	res, err := self.BackupTalk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
	})
...
func (self *Account) NewGetGroupPurgeMode(groupId string) (string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupPurgeSip(groupId string) (string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupOpType1(groupId string) (string, map[string]int64) {
	res, err := self.BackupTalk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupOpType2(groupId string) (string, map[string]int64) {
	res, err := self.BackupTalk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupFunctionOpType1(groupId string) (string, map[string]int64) {
	res, err := self.BackupTalk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupFunctionOpType2(groupId string) (string, map[string]int64) {
	res, err := self.BackupTalk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
...
func (self *Account) NewGetGroupGetBoots(groupId string) (string, map[string]int64) {
	res, err := self.Talk().GetChats(context.TODO(), &talkservice.GetChatsRequest{
		ChatMids:     []string{groupId},
		WithInvitees: false,
		WithMembers:  true,
